...
public class MySqlProfileDao extends MySqlDaoBase implements ProfileDao
{
    ...
    public Profile update(int userId, Profile profile) {
        try (
                ...
                // user's profile updated. COALESCE ensures that if a provided value is null,
                // existing value in  database is retained instead of being overwritten.
            ...
            //map profile field values the SQL statement parameters
            //(can be null — COALESCE handles that in SQL).
            ...
            q.executeUpdate(); //executes the updated statement
        } catch (SQLException e) {
